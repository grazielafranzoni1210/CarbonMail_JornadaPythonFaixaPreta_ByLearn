...
from carbonmail.database.manager import create_list as db_create_contact
...
def load_lists(): # para carregar todas as listas
    lists = search_list()
    lists = [_list[1] for _list in lists] # compreensão de lista: nessa minha lists vamos add uma list em 1
    # para cada variável que existir na minha lists
...
def import_contacts(csv_path, list_name):
    ...
    with open(csv_path, "r", encoding="utf-8") as csv_file:
        ...
        # No inglês = vírgula separa dados
        # No português = vírgula também é para casas decimais
        # 10.5 = 10,5
        # 10,5, 'Graziela'
        # 10   5   Graziela
        # 10,5     Graziela
        # CSV (PT-BR) = Separado por ponto e vírgula (;)
        # 10,5;'Graziela'        
